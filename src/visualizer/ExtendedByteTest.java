/**
 * Runs a variety of conversions to ensure that data is being translated
 * into the expected format and value.
 */
package visualizer;
...
public class ExtendedByteTest {
		...
		@Test
		// Test that the same number that gets put in is what comes out.
		public void testHexToByteConversions() {
			for (int i = 1; i < 5000; i++) {
				assertEquals(i,
						ExtendedByte.fromByteArray(ExtendedByte.toByteArray(i)));
			}
		}
		...
		public void testDecimalToHexConversion() {
			...
			byte[] byteLiteralOfInput = { 0b00010011, 0b00001011, 0b00000000,
					0b00000000 };
		...
		public void testDecimalToHexConversion2() {
			...
			byte[] byteLiteralOfInput = { 0b00011001, 0b00111101, 0b00000000,
					0b00000000 };
		...
		public void testDecimalToHexConversion3() {
			...
			byte[] byteLiteralOfInput = { 0b00100000, 0b00100000, 0b01000010,
					0b00000001 };
